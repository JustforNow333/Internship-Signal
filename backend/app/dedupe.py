...
# Re-exported for existing callers; these identity primitives are owned by the
# neutral domain package that watcher consumers import directly.
from internship_signal.domain.identity import (
    _squash,
    norm_company,
    norm_title,
    norm_url,
