...
40. Evidence-first repository cleanup (2026-08-01):
   ...
   - Validation passed: backend/watcher `841 passed, 1 warning`; frontend `23
     ...
     parsing. Production collection still defaults to `serial`.

41. Live audit retained-detail regression fix (2026-08-02):
