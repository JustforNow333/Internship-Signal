...
from watcher.pipeline import (
    ...
    RUN_MODE_PRIME,
    RUN_MODES,
    SHADOW_GENERATION_REPORT_LIMIT,
    RunResult,
    _generation_absence_health,
    run_once,
)
...
# adapter and registry tests import `_default_direct_sources`,
# `_DirectSourceProvider`, `_DirectFetchOutcome`, `_direct_outcome_from_result`,
# `_direct_diagnostics_from_source`, and `_generation_absence_health` from here.
