"""The sanitized JSON health artifact, workflow output, and the health CLI.

``python -m watcher.source_health workflow-report|final-heartbeat`` runs the
``_main`` below through the compatibility facade; the scheduled workflow calls
