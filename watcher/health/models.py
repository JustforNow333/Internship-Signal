"""Constants and dataclasses shared across the health modules.

Status names, alert types, severities, reason codes, and policy thresholds are
persisted or rendered, so they are stable identifiers rather than presentation
choices. Every health module reads them from here.
"""
