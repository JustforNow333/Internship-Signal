"""Total sanitizers and UTC helpers shared by every health module.

Every function here runs over arbitrary failure text, including text built from
a malformed URL, and must never raise.
"""
