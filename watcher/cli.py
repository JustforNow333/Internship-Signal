"""Command-line entry point for a single watcher run.

Argument parsing, watchlist/seen-store startup, snapshot capture and replay
wiring, and the report/heartbeat calls that end the process. The pipeline
itself lives in :mod:`watcher.pipeline`.
"""
...
from watcher.reporting import (
    _write_result_health_report,
    print_heartbeat,
    print_report,
)
