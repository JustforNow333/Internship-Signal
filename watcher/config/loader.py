...
from .validation import (
    ...
    _validate_jane_street_config,
    _validate_lam_research_config,
    _validate_mediatek_config,
    _validate_oracle_hcm_config,
    _validate_optiver_config,
...
def _build_company(entry: dict, default_terms: tuple[str, ...]) -> CompanyCfg:
    ...
    if ats == "talentbrew":
        ...
        _validate_jane_street_config(name, source_url=source_url)
        ...
        _validate_optiver_config(name, source_url=source_url)
    elif ats == "siemens":
